...
* **Sandbox Isolation**: Execution of autonomous tasks inside ephemeral, rootless Podman containers. Full guardrail and constraint injection via local workspace policies (`CLAUDE.md`, `AGENTS.md`, etc.).
