...
def test_package_version() -> None:
    """Verify that the package version has been bumped to 2.0.0."""
    assert __version__ == "2.0.0"


def test_pyproject_version() -> None:
    """Verify that pyproject.toml version has been bumped to 2.0.0."""
...
def test_observability_version() -> None:
    """Verify that the tracing resource metadata service version has been bumped to 2.0.0."""
...
def test_helm_chart_version() -> None:
    """Verify that Helm Chart.yaml version and appVersion have been bumped to 2.0.0."""
